            ...
            <div className='row'>
                <div className={`col-11 ${showRef ? 'ref-w' : 'full-w'}`}>
                    <div style={{ margin: 25 }}>
                        ...
                        <Alert variant="danger" show={showError} style={{ margin: 25 }} onClose={() => setShowError(false)} dismissible>
                    ...
                    <div name='the product' style={{ marginTop: 30, marginLeft: 0, marginRight: 50 }}>
                        ...
                        <div className='rightColumn' style={{ textAlign: 'justify' }}>
                            <h1>Customizable Storehouse Plaque</h1>
                            <h4>Painted plaque to place on your tax and surplus storehouse, to ensure proper consencration and distribution. </h4>
                            <ul>
                                <li>The stone plaque is made of durable limestone, carved from the rocks by expert carvers. The rock is strong enough to be banged against without breaking.</li>
                                <li>The papyrus is made from suf reeds, dried and pressed by the whatever firm. All papyrus products are in compliance with the Save The Reeds Enviroment Organization Guidelines.</li>
                                <li>Hand dyed with bright colors. All dyes are vegan.</li>
                                <li>Standard text: ‘The grain within is consecrated for the purpose of saving the New Egyptian Kingdom’</li>
                                <li>Optional: Includes Rosetta Stone, for simultaneous translation</li>
                            </ul>
